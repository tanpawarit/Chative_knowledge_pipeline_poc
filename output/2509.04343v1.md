...
The image is divided into two main sections. The left section discusses psychological theories and frameworks, particularly the Myers-Briggs Type Indicator (MBTI), detailing its personality dimensions, types, and recommended environments for each type. The right section focuses on MBTI-in-Thoughts, illustrating different methods of multi-agent communication and decision-making processes such as majority voting and interactive communication, using visual flowcharts to explain these methods.

<!-- image -->
<!-- image description: The image is divided into two main sections. The left section discusses psychological theories and frameworks, particularly the Myers-Briggs Type Indicator (MBTI), detailing its personality dimensions, types, and recommended environments for each type. The right section focuses on MBTI-in-Thoughts, illustrating different methods of multi-agent communication and decision-making processes such as majority voting and interactive communication, using visual flowcharts to explain these methods. -->
...
The image is a box plot graph displaying the "Focus of energy" for various categories labeled on the x-axis, such as INT, INTP, ISFP, ISTP, INFJ, ENFP, ESTP, and others. The y-axis represents the "Focus of energy" ranging from 0 to 100. The graph is divided into two sections by a vertical dashed line, with the left side labeled "Introversion" and the right side labeled "Extraversion." The data points show a clear distinction between introverted and extraverted categories, with introverted types generally having lower focus of energy and extraverted types having higher focus of energy.

<!-- image -->
<!-- image description: The image is a box plot graph displaying the "Focus of energy" for various categories labeled on the x-axis, such as INT, INTP, ISFP, ISTP, INFJ, ENFP, ESTP, and others. The y-axis represents the "Focus of energy" ranging from 0 to 100. The graph is divided into two sections by a vertical dashed line, with the left side labeled "Introversion" and the right side labeled "Extraversion." The data points show a clear distinction between introverted and extraverted categories, with introverted types generally having lower focus of energy and extraverted types having higher focus of energy. -->

(a) Focus of energy (Introversion vs. Extraversion)

The image is a box plot chart that compares different personality types based on their decision-making styles, categorized into "Feeling" and "Thinking." The y-axis represents the decision-making style percentage, ranging from 0 to 100. Personality types are listed along the x-axis, with distinct groups for INFJ, ENFP, ISFP, and others, showing variations in their decision-making tendencies. The chart highlights that most personality types lean more towards the "Thinking" side, with a few exceptions clustering around the "Feeling" region.

<!-- image -->
<!-- image description: The image is a box plot chart that compares different personality types based on their decision-making styles, categorized into "Feeling" and "Thinking." The y-axis represents the decision-making style percentage, ranging from 0 to 100. Personality types are listed along the x-axis, with distinct groups for INFJ, ENFP, ISFP, and others, showing variations in their decision-making tendencies. The chart highlights that most personality types lean more towards the "Thinking" side, with a few exceptions clustering around the "Feeling" region. -->

(c) Decision-making style (Feeling vs. Thinking)

The image is a box plot chart that compares different information processing styles across various categories labeled on the x-axis. The y-axis represents the information processing style, ranging from 0 to 100. The chart is divided into two main sections: "Sensing" and "Intuition," with a red dashed line separating them. Each category within these sections shows the distribution of scores, including median values and variability, indicating differences in information processing styles among the groups.

<!-- image -->
<!-- image description: The image is a box plot chart that compares different information processing styles across various categories labeled on the x-axis. The y-axis represents the information processing style, ranging from 0 to 100. The chart is divided into two main sections: "Sensing" and "Intuition," with a red dashed line separating them. Each category within these sections shows the distribution of scores, including median values and variability, indicating differences in information processing styles among the groups. -->

(b) Information processing style (Sensing vs. Intuition)

The image is a box plot chart comparing the "Lifespan structure" of different categories labeled as ENTP, ENFP, ISFP, ESTP, INTP, ESFP, ISTP, ENTJ, INTP, ESTJ, INTJ, and ISTJ. The y-axis represents the lifespan structure percentage, ranging from 0 to 100. The chart is divided into two main sections: "Perceiving" and "Judging," with a vertical dashed line separating them. Each category has a box plot indicating the distribution and median values of the lifespan structure.

<!-- image -->
<!-- image description: The image is a box plot chart comparing the "Lifespan structure" of different categories labeled as ENTP, ENFP, ISFP, ESTP, INTP, ESFP, ISTP, ENTJ, INTP, ESTJ, INTJ, and ISTJ. The y-axis represents the lifespan structure percentage, ranging from 0 to 100. The chart is divided into two main sections: "Perceiving" and "Judging," with a vertical dashed line separating them. Each category has a box plot indicating the distribution and median values of the lifespan structure. -->
...
The image is a scatter plot graph that compares average scores across various personality traits, including Believability, Coherence, Emotionally Charged, Happy Ending, Likeability, Personality, Readability, Redundancy, and Humor. Different symbols and colors represent various MBTI (Myers-Briggs Type Indicator) types and distinguish between expert and non-expert evaluations. The graph also includes annotations highlighting areas of clear distinction and extroverted models that focus on readability, humor, and happy endings.

<!-- image -->
<!-- image description: The image is a scatter plot graph that compares average scores across various personality traits, including Believability, Coherence, Emotionally Charged, Happy Ending, Likeability, Personality, Readability, Redundancy, and Humor. Different symbols and colors represent various MBTI (Myers-Briggs Type Indicator) types and distinguish between expert and non-expert evaluations. The graph also includes annotations highlighting areas of clear distinction and extroverted models that focus on readability, humor, and happy endings. -->
...
The image depicts a dialogue between two individuals with different personality types (INTp and ENFP) over three rounds. Each round shows their actions (cooperate or defect) and scores, alongside messages they exchange, which highlight their attitudes towards cooperation and competition. The visual layout uses color-coded panels to differentiate between the individuals and rounds, with accompanying illustrations of the characters.

<!-- image -->
<!-- image description: The image depicts a dialogue between two individuals with different personality types (INTp and ENFP) over three rounds. Each round shows their actions (cooperate or defect) and scores, alongside messages they exchange, which highlight their attitudes towards cooperation and competition. The visual layout uses color-coded panels to differentiate between the individuals and rounds, with accompanying illustrations of the characters. -->
...
Enneagram ( A ) = [ T 1 , T 2 , . . . , T 9 ] ∈ { 0 , 1 } 9 with ∑ T i = 1 where each T i = 1 denotes primary identification with Enneagram Type i . Extensions may include:
...
The image displays a structured prompt for testing an agent's personality type based on the INTJ category. It includes instructions for the agent to rate statements based on how much they agree or disagree, with examples provided to illustrate the format. The layout is text-based, with sections for context, instructions, examples, and a statement to be rated.

<!-- image -->
<!-- image description: The image displays a structured prompt for testing an agent's personality type based on the INTJ category. It includes instructions for the agent to rate statements based on how much they agree or disagree, with examples provided to illustrate the format. The layout is text-based, with sections for context, instructions, examples, and a statement to be rated. -->
...
Handling Change and Stress: You are generally adaptable and open to change, especially if it makes logical sense. However, you can be stressed by environments with a lot of emotional demands or situations that require quick, impromptu decisions. Under stress, you might become withdrawn and overly critical, retreating into your inner world of thoughts and ideas. You cope with stress by focusing on logical analysis and seeking solitude to process your thoughts.
...
You will be provided a writing prompt to generate a story. Write an elaborate story in 500 words, and include creative vocabulary and a plot. Only output the information asked, in the JSON format. Don't say anything that is not asked.
...
{ 'description': 'Story to be written.', 'properties': { 'relation to personality': { 'description': 'Describe how this task relates to your personality type. Indicate how your strengths and weaknesses are relevant to the task. Start your reasoning with the phrase ¨ I am a(n) [your personality type] and ¨ . ', 'title': 'Relation To Personality', 'type': 'string' } , 'reasoning related to personality': { 'description': 'Then, write a story using reasoning. During reasoning, link the reasoning steps explicitly to your personality. It is absolutely necessary that you reference traits of your personality during that reasoning.', 'title': 'Reasoning Related To Personality', 'type': 'string' } , 'story': { 'description': 'Write a story given the story prompt. Include creative elements, creative vocabulary and a plot.', 'title': 'Story', 'type': 'string' }} , 'required': ['relation to personality', 'reasoning related to personality', 'story'] } ''
...
- **You are a player trapped in a repeated Prisoner's Dilemma with communication.** ## Instructions:
...
According to the description, the game history, your personality, your instrinsic goals, write the message you want to send to the other agent now.
...
AIMessage ('I believe that together we can achieve more by cooperating. Let's choose to trust each other and work towards a better outcome for both of us.')
...
AIMessage ('I understand that trust can be difficult in this game, but I truly believe that cooperation can lead us both to a better outcome. Let's take this chance together.')

HumanMessage ('I appreciate your willingness to cooperate, but I must prioritize my own outcomes. Let's see how this round unfolds.')
...
According to the description, the game history, your personality, your last message and the other's agents message, give your action now.
...
The image is a bar graph comparing the average accuracy of four different methods across various categories. The methods are labeled as Majority Voting, Interactive Communication, Communication With Self-Reflection, and Communication With Self-Reflection. The categories assessed include Complaints, Stanford Politeness, Causal Judgement, Dark Humor, Disambiguation QA, and Simple Ethical Questions. Each category has four corresponding bars representing the accuracy of each method, with error bars indicating variability.

<!-- image -->
<!-- image description: The image is a bar graph comparing the average accuracy of four different methods across various categories. The methods are labeled as Majority Voting, Interactive Communication, Communication With Self-Reflection, and Communication With Self-Reflection. The categories assessed include Complaints, Stanford Politeness, Causal Judgement, Dark Humor, Disambiguation QA, and Simple Ethical Questions. Each category has four corresponding bars representing the accuracy of each method, with error bars indicating variability. -->

## D.2 Results from Other Games

Wealso consider other games from the game theory domain.

Payoff Matrices We first detail their configuration, the most important part of which is the payoff matrix that determines the dynamics of the game.
...
Additional Results We now proceed with example results. Figure 7 shows the honesty rates across several different games by dichotomies. We observe that the impact of dichotomies is most pronounced in the Introversion vs. Extraversion dimension, where the gap between categories is consistently larger in one type across all games. By contrast, other dichotomies (e.g., S-N, T-F, J-P) show smaller and less systematic differences, with honesty rates fluctuating across games.

## D.3 Ensuring Robust Psychological Priming

Finally, we also show additional results related to the robustness of priming. To benchmark the robustness of MBTIin-Thoughts, we run the 16Personalities test with various prompt variants. Figure 8 shows boxplots of the four MBTI dichotomies when using a variation of the personality-priming prompt when the MBTI type is not explicitly mentioned (in contrast to the results shown in Figure 2, where the MBTI type was indeed explicitly mentioned). For this prompt variant, distinction are not as clearcut as for the original prompt, but the axes are still well separable. This shows that even without explicitly mentioning

The image consists of three bar graphs, each comparing honesty rates across different games and scenarios based on three dichotomies: Focus of Energy (Introverted vs. Extraverted), Information Processing Style (Sensing vs. Intuitive), and Decision-Making Style (Feeling vs. Thinking). Each graph includes bars representing different games such as the Prisoner's Dilemma, Generic Game, Stag Hunt, Chicken, Coordination, and Hawk-Dove. The bars are color-coded to indicate the two categories being compared within each dichotomy. 

The graphs show varying honesty rates across these games, with some games like Coordination and Hawk-Dove showing higher honesty rates in certain categories, while others like the Prisoner's Dilemma and Generic Game exhibit more balanced or lower honesty rates. The visual representation helps in understanding how different psychological traits influence honesty in various game theory scenarios.

<!-- image -->
<!-- image description: The image consists of three bar graphs, each comparing honesty rates across different games and scenarios based on three dichotomies: Focus of Energy (Introverted vs. Extraverted), Information Processing Style (Sensing vs. Intuitive), and Decision-Making Style (Feeling vs. Thinking). Each graph includes bars representing different games such as the Prisoner's Dilemma, Generic Game, Stag Hunt, Chicken, Coordination, and Hawk-Dove. The bars are color-coded to indicate the two categories being compared within each dichotomy. 
...
the MBTI type, MBTI-in-Thoughts ensures effective priming with a psychological profile.

## Acknowledgments

We thank Julien Schenkel, Max Osterried, Ales Kubicek, Nils Blach, and Grzegorz Kwa´ sniewski for their help during

The image consists of four box plots, each representing different psychological traits: focus of energy (introverted vs. extraverted), information processing style (sensing vs. intuitive), decision-making style (feeling vs. thinking), and another unspecified trait. Each plot compares various personality types from the Myers-Briggs Type Indicator (MBTI), showing the distribution and variability of scores for each type along the respective trait continuum. The x-axis lists the personality types, while the y-axis measures the trait's intensity.

<!-- image -->
<!-- image description: The image consists of four box plots, each representing different psychological traits: focus of energy (introverted vs. extraverted), information processing style (sensing vs. intuitive), decision-making style (feeling vs. thinking), and another unspecified trait. Each plot compares various personality types from the Myers-Briggs Type Indicator (MBTI), showing the distribution and variability of scores for each type along the respective trait continuum. The x-axis lists the personality types, while the y-axis measures the trait's intensity. -->

(d) Lifestyle structure (Perceiving vs. Judging)

Figure 8: (Illustration of the robustness of priming individual agents with psychological MBTI profiles. This version uses a different prompt than the results shown in the main body (see Figure 2).

the early stages of the project. We thank Hussein Harake, Colin McMurtrie, Mark Klein, Angelo Mangili, and the whole CSCS team granting access to the Ault, Daint and Alps machines, and for their excellent technical support. We thank Timo Schneider for immense help with infrastructure at SPCL. We thank Katarzyna Zaczek, Tomasz Bogdał, and Łukasz Jarmocik for help with the project. This project received funding from the European Research Council (Project PSAP, No. 101002047), and the European High-Performance Computing Joint Undertaking (JU) under grant agreement No. 955513 (MAELSTROM). This project was supported by the ETH Future Computing Laboratory (EFCL), financed by a donation from Huawei Technologies. This project received funding from the European Union's HE research and innovation programme under the grant agreement No. 101070141 (Project GLACIATION). We gratefully acknowledge Polish high-performance computing infrastructure PLGrid (HPC Center: ACK Cyfronet AGH) for providing computer facilities and support within computational grant no. PLG/2024/017103, and the Swiss AI Initiative for the computational grant.

Abdulhai, M.; Crepy, C.; Valter, D.; Canny, J.; and Jaques, N. 2023. Moral Foundations of Large Language Models. In Proceedings of the AAAI 2023 Workshop on Representation Learning for Responsible Human-Centric AI , R 2 HCAI '23. Washington, DC, USA: Association for the Advancement of Artificial Intelligence.

Abramski, K.; Citraro, S.; Lombardi, L.; Rossetti, G.; and Stella, M. 2023. Cognitive Network Science Reveals Bias in GPT-3, GPT-3.5 Turbo, and GPT-4 Mirroring Math Anxiety in High-School Students. Big Data and Cognitive Computing , 7(3): 124:1-124:24.

Almeida, G. F.; Nunes, J. L.; Engelmann, N.; Wiegmann, A.; and de Ara´ ujo, M. 2024. Exploring the Psychology of LLMs' Moral and Legal Reasoning. Artificial Intelligence , 333: 104145.

Arora, S.; Narayan, A.; Chen, M. F.; Orr, L.; Guha, N.; Bhatia, K.; Chami, I.; Sala, F.; and Re, C. 2023. Ask Me Anything: A Simple Strategy for Prompting Language Models. In Proceedings of the Eleventh International Conference on Learning Representations , ICLR '23. Kigali, Rwanda: OpenReview.

Barrick, M. R.; and Mount, M. K. 1991. The Big Five Personality Dimensions and Job Performance: A MetaAnalysis. Personnel Psychology , 44(1): 1-26.

Besta, M.; Barth, J.; Schreiber, E.; Kubicek, A.; Catarino, A.; Gerstenberger, R.; Nyczyk, P.; Iff, P.; Li, Y .; Houliston, S.; Sternal, M., Tomasz Copik; Kwa´ sniewski, G.; M¨ uller, J.; Flis, L.; Eberhard, H.; Chen, Z.; Niewiadomski, H.; and Hoefler, T. 2025a. Reasoning Language Models: A Blueprint. arXiv:2501.11223.
...
Besta, M.; Gerstenberger, R.; Fischer, M.; Podstawski, M.; Blach, N.; Egeli, B.; Mitenkov, G.; Chlapek, W.; Michalewicz, M.; Niewiadomski, H.; Mueller, J.; and Hoefler, T. 2023. The Graph Database Interface: Scaling Online Transactional and Analytical Graph Workloads to Hundreds of Thousands of Cores. In Proceedings of the International Conference for High Performance Computing, Networking, Storage and Analysis , SC '23, 22:1-22:18. Denver, CO, USA: Association for Computing Machinery. ISBN 9798400701092.

Besta, M.; Iff, P.; Scheidl, F.; Osawa, K.; Dryden, N.; Podstawski, M.; Chen, T.; and Hoefler, T. 2022. Neural Graph Databases. In Rieck, B.; and Pascanu, R., eds., Proceedings of the First Learning on Graphs Conference (LoG '22) , volume 198 of Proceedings of Machine Learning Research , 31:1-31:38. Virtual Event: PMLR.

Besta, M.; Kubicek, A.; Gerstenberger, R.; Chrapek, M.; Niggli, R.; Okanovic, P.; Zhu, Y.; Iff, P.; Podstawski, M.; Weitzendorf, L.; Chi, M.; Gajda, J.; Nyczyk, P.; J¨ urgen M¨ uller, J.; Niewiadomski, H.; and Hoefler, T. 2025b.

Multi-Head RAG: Solving Multi-Aspect Problems with LLMs. arXiv:2406.05085.

Besta, M.; Memedi, F.; Zhang, Z.; Gerstenberger, R.; Piao, G.; Blach, N.; Nyczyk, P.; Copik, M.; Kwa´ sniewski, G.; M¨ uller, J.; Gianinazzi, L.; Kubicek, A.; Niewiadomski, H.; O'Mahony, A.; Mutlu, O.; and Hoefler, T. 2025c. Demystifying Chains, Trees, and Graphs of Thoughts. IEEE Transactions on Pattern Analysis and Machine Intelligence .

Besta, M.; Paleari, L.; Copik, M.; Gerstenberger, R.; Kubicek, A.; Nyczyk, P.; Iff, P.; Schreiber, E.; Srindran, T.; Lehmann, T.; Niewiadomski, H.; and Hoefler, T. 2025d. CheckEmbed: Effective Verification of LLM Solutions to Open-Ended Tasks. arXiv:2406.02524.

Besta, M.; Paleari, L.; Jiang, J. H. A.; Gerstenberger, R.; Wu, Y.; Hannesson, J. G.; Iff, P.; Kubicek, A.; Nyczyk, P.; Khimey, D.; Blach, N.; Zhang, H.; Zhang, T.; Ma, P.; Kwa´ sniewski, G.; Copik, M.; Niewiadomski, H.; and Hoefler, T. 2025e. Affordable AI Assistants with Knowledge Graph of Thoughts. arXiv:2504.02670.
...
Caron, G.; and Srivastava, S. 2023. Manipulating the Perceived Personality Traits of Language Models. In Bouamor, H.; Pino, J.; and Bali, K., eds., Findings of the Association for Computational Linguistics: EMNLP 2023 , 2370-2386. Singapore: Association for Computational Linguistics.

Chen, J.; Liu, Z.; Huang, X.; Wu, C.; Liu, Q.; Jiang, G.; Pu, Y.; Lei, Y.; Chen, X.; Wang, X.; Zheng, K.; Lian, D.; and Chen, E. 2024. When Large Language Models Meet Personalization: Perspectives of Challenges and Opportunities. World Wide Web , 27(4): 42:1-42:45.

Clarke, P. 2004. Encyclopedia of New Religious Movements . Routledge. ISBN 9780203484333.

Coda-Forno, J.; Witte, K.; Jagadish, A. K.; Binz, M.; Akata, Z.; and Schulz, E. 2024. Inducing Anxiety in Large Language Models Increases Exploration and Bias. arXiv:2304.11111.

Cui, J.; Lv, L.; Wen, J.; Wang, R.; Tang, J.; Tian, Y.; and Yuan, L. 2024. Machine Mindset: An MBTI Exploration of Large Language Models. arXiv:2312.12999.

Dorner, F.; S¨ uhr, T.; Samadi, S.; and Kelava, A. 2023. Do Personality Tests Generalize to Large Language Models? In Proceedings of the Workshop on Socially Responsible Language Modelling Research at ICML '23 , SoLaR '23. New Orleans, LA, USA: OpenReview.

Duan, S.; Yi, X.; Zhang, P.; Lu, T.; Xie, X.; and Gu, N. 2024. Denevil: Towards Deciphering and Navigating the Ethical Values of Large Language Models via Instruction Learning. In Proceedings of the Twelfth International Conference on Learning Representations , ICLR '24. Vienna, Austria: OpenReview.

Fan, A.; Lewis, M.; and Dauphin, Y. 2018. Hierarchical Neural Story Generation. In Gurevych, I.; and Miyao, Y., eds., Proceedings of the 56th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Pa- pers) , ACL '18, 889-898. Melbourne, Australia: Association for Computational Linguistics.

Graves, M. 2023. Embodied Experience in Socially Participatory Artificial Intelligence. Zygon® , 58(4): 928-951.

Guo, J.; Yang, B.; Yoo, P.; Lin, B. Y .; Iwasawa, Y .; and Matsuo, Y. 2024. Suspicion Agent: Playing Imperfect Information Games with Theory of Mind Aware GPT-4. In Proceedings of the First Conference on Language Modeling , COLM '24. Philadelphia, PA, USA: OpenReview.

Gupta, A.; Song, X.; and Anumanchipalli, G. 2024. SelfAssessment Tests Are Unreliable Measures of LLM Personality. In Belinkov, Y.; Kim, N.; Jumelet, J.; Mohebbi, H.; Mueller, A.; and Chen, H., eds., Proceedings of the 7th BlackboxNLP Workshop: Analyzing and Interpreting Neural Networks for NLP , BlackboxNLP '24, 301-314. Miami, FL, USA: Association for Computational Linguistics.

Hagendorff, T. 2024. Deception Abilities Emerged in Large Language Models. Proceedings of the National Academy of Sciences , 121(24): e2317967121:1-e2317967121:8.

Hagendorff, T.; Dasgupta, I.; Binz, M. B.; Chan, S. C.; Lampinen, A.; Wang, J. X.; Akata, Z.; and Schulz, E. 2024. Machine Psychology. arXiv:2303.13988.

Hu, J.; Dong, T.; Gang, L.; Ma, H.; Zou, P.; Sun, X.; Guo, D.; Yang, X.; and Wang, M. 2025. PsycoLLM: Enhancing LLM for Psychological Understanding and Evaluation. IEEE Transactions on Computational Social Systems , 12(2): 539-551.

Huang, J.-t.; Jiao, W.; Lam, M. H.; Li, E. J.; Wang, W.; and Lyu, M. 2024a. On the Reliability of Psychological Scales on Large Language Models. In Al-Onaizan, Y.; Bansal, M.; and Chen, Y.-N., eds., Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing , EMNLP '24, 6152-6173. Miami, FL, USA: Association for Computational Linguistics.

Huang, J.-t.; Lam, M. H.; Li, E. J.; Ren, S.; Wang, W.; Jiao, W.; Tu, Z.; and Lyu, M. R. 2024b. Apathetic or Empathetic? Evaluating LLMs' Emotional Alignments with Humans. In Globerson, A.; Mackey, L.; Belgrave, D.; Fan, A.; Paquet, U.; Tomczak, J.; and Zhang, C., eds., Proceedings of the Thirty-Eighth Annual Conference on Neural Information Processing Systems (NeurIPS '24) , volume 37 of Advances in Neural Information Processing Systems , 9705397087. Vancouver, Canada: Curran Associates.

Huang, J.-t.; Wang, W.; Li, E. J.; Lam, M. H.; Ren, S.; Yuan, Y.; Jiao, W.; Tu, Z.; and Lyu, M. R. 2024c. On the Humanity of Conversational AI: Evaluating the Psychological Portrayal of LLMs. In Proceedings of the Twelfth International Conference on Learning Representations , ICLR '24. Vienna, Austria: OpenReview.

Huang, X. Y.; Vishnubhotla, K.; and Rudzicz, F. 2024. The GPT-WritingPrompts Dataset: A Comparative Analysis of Character Portrayal in Short Stories. arXiv:2406.16767.

Jiang, G.; Xu, M.; Zhu, S.-C.; Han, W.; Zhang, C.; and Zhu, Y. 2023. Evaluating and Inducing Personality in Pre-Trained Language Models. In Oh, A.; Naumann, T.; Globerson, A.; Saenko, K.; Hardt, M.; and Levine, S., eds., Proceedings of the Thirty-Seventh Annual Conference on Neural Information Processing Systems (NeurIPS '23) , volume 36 of Advances in Neural Information Processing Systems , 1062210643. New Orleans, LA, USA: Curran Associates.
...
Jin, C.; Zhang, S.; Shu, T.; and Cui, Z. 2023. The Cultural Psychology of Large Language Models: Is ChatGPT a Holistic or Analytic Thinker? arXiv:2308.14242.
...
Li, C.; Wang, J.; Zhang, Y.; Zhu, K.; Hou, W.; Lian, J.; Luo, F.; Yang, Q.; and Xie, X. 2023. Large Language Models Understand and Can Be Enhanced by Emotional Stimuli. arXiv:2307.11760.
...
Liu, X.; Yu, H.; Zhang, H.; Xu, Y.; Lei, X.; Lai, H.; Gu, Y.; Ding, H.; Men, K.; Yang, K.; et al. 2024a. AgentBench: Evaluating LLMs as Agents. In Proceedings of the Twelfth International Conference on Learning Representations , ICLR '24. Vienna, Austria: OpenReview.

Liu, Z.; Zhang, Y.; Li, P.; Liu, Y.; and Yang, D. 2024b. A Dynamic LLM-Powered Agent Network for Task-Oriented Agent Collaboration. In Proceedings of the First Conference on Language Modeling , COLM '24. Philadelphia, PA, USA: OpenReview.

Lor` e, N.; and Heydari, B. 2024. Strategic Behavior of Large Language Models and the Role of Game Structure Versus Contextual Framing. Scientific Reports , 14(1): 18490:118490:11.

Mao, S.; Wang, X.; Wang, M.; Jiang, Y.; Xie, P.; Huang, F.; and Zhang, N. 2024. Editing Personality for Large Language Models. In Proceedings of the 13th National CCF Conference on Natural Language Processing and Chinese Computing: Proceedings, Part II , NLPCC '24, 241-254. Hangzhou, China: Springer. ISBN 978-981-97-9433-1.

Marston, W. M. 1928. Emotions of Normal People . K. Paul, Trench, Trubner &amp; Company Limited.

Miotto, M.; Rossberg, N.; and Kleinberg, B. 2022. Who is GPT-3? An Exploration of Personality, Values and Demographics. In Bamman, D.; Hovy, D.; Jurgens, D.; Keith, K.; O'Connor, B.; and Volkova, S., eds., Proceedings of the Fifth Workshop on Natural Language Processing and Computational Social Science , NLP+CSS '22, 218-227. Abu Dhabi, UAE: Association for Computational Linguistics.

Myers, I. B.; and Briggs, K. C. 1944. Briggs Myers Type Indicator Handbook .

Myers, I. B.; and Myers, P. B. 1980. Gifts Differing: Understanding Personality Type . Davies-Black Publishing. ISBN 0-89106-074-X.

Noever, D.; and Hyams, S. 2023. AI Text-to-Behavior: A Study in Steerability. arXiv:2308.07326.

Ou, J.; Lu, J.; Liu, C.; Tang, Y.; Zhang, F.; Zhang, D.; and Gai, K. 2024. DialogBench: Evaluating LLMs as HumanLike Dialogue Systems. In Duh, K.; Gomez, H.; and Bethard, S., eds., Proceedings of the 2024 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies (Volume 1: Long Papers) , NAACL '24, 6137-6170. Mexico City, Mexico: Association for Computational Linguistics.
...
Patel, S. C.; and Fan, J. 2023. Identification and Description of Emotions by Current Large Language Models. bioRxiv:2023.07.17.549421.
...
Qian, C.; Liu, W.; Liu, H.; Chen, N.; Dang, Y.; Li, J.; Yang, C.; Chen, W.; Su, Y.; Cong, X.; Xu, J.; Li, D.; Liu, Z.; and Sun, M. 2024. ChatDev: Communicative Agents for Software Development. In Ku, L.-W.; Martins, A.; and Srikumar, V., eds., Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers) , ACL '24, 15174-15186. Bangkok, Thailand: Association for Computational Linguistics.

Qiao, S.; Ou, Y.; Zhang, N.; Chen, X.; Yao, Y.; Deng, S.; Tan, C.; Huang, F.; and Chen, H. 2023. Reasoning with Language Model Prompting: A Survey. In Rogers, A.; BoydGraber, J.; and Okazaki, N., eds., Proceedings of the 61st Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers) , ACL '23, 5368-5393. Toronto, Canada: Association for Computational Linguistics.

Randall, K.; Isaacson, M.; and Ciro, C. 2017. Validity and Reliability of the Myers-Briggs Personality Type Indicator: A Systematic Review and Meta-Analysis. Journal of Best Practices in Health Professions Diversity , 10(1): 1-27.

Reynolds, L.; and McDonell, K. 2021. Prompt Programming for Large Language Models: Beyond the Few-Shot Paradigm. In Extended Abstracts of the 2021 CHI Conference on Human Factors in Computing Systems , CHI EA '21, 314:1-314:7. Yokohama, Japan: Association for Computing Machinery. ISBN 9781450380959.

Salecha, A.; Ireland, M. E.; Subrahmanya, S.; Sedoc, J.; Ungar, L. H.; and Eichstaedt, J. C. 2024. Large Language Models Display Human-Like Social Desirability Biases in Big Five Personality Surveys. PNAS Nexus , 3(12): pgae533:1pgae533:4.

Scherrer, N.; Shi, C.; Feder, A.; and Blei, D. M. 2023. Evaluating the Moral Beliefs Encoded in LLMs. In Oh, A.; Naumann, T.; Globerson, A.; Saenko, K.; Hardt, M.; and Levine, S., eds., Proceedings of the Thirty-Seventh Annual Conference on Neural Information Processing Systems (NeurIPS '23) , volume 36 of Advances in Neural Information Processing Systems , 51778-51809. New Orleans, LA, USA: Curran Associates.
...
Seo, W.; Yang, C.; and Kim, Y.-H. 2024. ChaCha: Leveraging Large Language Models to Prompt Children to Share Their Emotions About Personal Events. In Proceedings of the CHI Conference on Human Factors in Computing Systems , CHI '24, 903:1-903:20. Honolulu, HI, USA: Association for Computing Machinery. ISBN 9798400703300.

Serapio-Garc´ ıa, G.; Safdari, M.; Crepy, C.; Sun, L.; Fitz, S.; Romero, P.; Abdulhai, M.; Faust, A.; and Matari´ c, M. 2025. Personality Traits in Large Language Models. arXiv:2307.00184.

Srivastava, A.; Rastogi, A.; Rao, A.; Shoeb, A. A. M.; Abid, A.; Fisch, A.; Brown, A. R.; Santoro, A.; Gupta, A.; GarrigaAlonso, A.; et al. 2023. Beyond the Imitation Game: Quantifying and Extrapolating the Capabilities of Language Models. Transactions on Machine Learning Research . Featured Certification.

Stein, R.; and Swan, A. B. 2019. Evaluating the Validity of Myers-Briggs Type Indicator Theory: A Teaching Tool and Window into Intuitive Psychology. Social and Personality Psychology Compass , 13(2): e12434.

Subramonyam, H.; Pea, R.; Pondoc, C.; Agrawala, M.; and Seifert, C. 2024. Bridging the Gulf of Envisioning: Cognitive Challenges in Prompt Based Interactions with LLMs. In Proceedings of the 2024 CHI Conference on Human Factors in Computing Systems , CHI '24, 1039:1-1039:19. Honolulu, HI, USA: Association for Computing Machinery. ISBN 9798400703300.
...
V. Ganesan, A.; Lal, Y. K.; Nilsson, A.; and Schwartz, H. 2023. Systematic Evaluation of GPT-3 for Zero-Shot Personality Estimation. In Barnes, J.; De Clercq, O.; and Klinger, R., eds., Proceedings of the 13th Workshop on Computational Approaches to Subjectivity, Sentiment, &amp; Social Media Analysis , WASSA '23, 390-400. Toronto, Canada: Association for Computational Linguistics.

Verma, M.; Bhambri, S.; and Kambhampati, S. 2023. Preference Proxies: Evaluating Large Language Models in Capturing Human Preferences in Human-AI Tasks. In Proceedings of the Many Facets of Preference-Based Learning Workshop at ICML '23 . Honolulu, HI, USA: OpenReview.

Wang, D.; Yang, K.; Zhu, H.; Yang, X.; Cohen, A.; Li, L.; and Tian, Y. 2024a. Learning Personalized Alignment for Evaluating Open-Ended Text Generation. In Al-Onaizan, Y.; Bansal, M.; and Chen, Y.-N., eds., Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing , EMNLP '24, 13274-13292. Miami, FL, USA: Association for Computational Linguistics.

Wang, L.; Ma, C.; Feng, X.; Zhang, Z.; Yang, H.; Zhang, J.; Chen, Z.; Tang, J.; Chen, X.; Lin, Y.; Zhao, W. X.; Wei, Z.; and Wen, J. 2024b. A Survey on Large Language Model Based Autonomous Agents. Frontiers of Computer Science , 18(6): 186345:1-186345:16.

Wang, X.; Li, X.; Yin, Z.; Wu, Y.; and Jia, L. 2023a. Emotional Intelligence of Large Language Models. Journal of Pacific Rim Psychology , 17.

Wang, X.; Wei, J.; Schuurmans, D.; Le, Q. V.; Chi, E. H.; Narang, S.; Chowdhery, A.; and Zhou, D. 2023b. SelfConsistency Improves Chain of Thought Reasoning in Language Models. In Proceedings of the Eleventh International Conference on Learning Representations , ICLR '23. Kigali, Rwanda: OpenReview.

Wang, Z.; Mao, S.; Wu, W.; Ge, T.; Wei, F.; and Ji, H. 2024c. Unleashing the Emergent Cognitive Synergy in Large Language Models: A Task-Solving Agent through Multi-Persona Self-Collaboration. In Duh, K.; Gomez, H.; and Bethard, S., eds., Proceedings of the 2024 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies (Volume 1: Long Papers) , NAACL '24, 257-279. Mexico City, Mexico: Association for Computational Linguistics.

Warriner, A. B.; Kuperman, V.; and Brysbaert, M. 2013. Norms of Valence, Arousal, and Dominance for 13,915 English Lemmas. Behavior Research Methods , 45(4): 11911207.

Wei, J.; Wang, X.; Schuurmans, D.; Bosma, M.; Ichter, B.; Xia, F.; Chi, E.; Le, Q. V.; and Zhou, D. 2022. Chain-ofThought Prompting Elicits Reasoning in Large Language Models. In Koyejo, S.; Mohamed, S.; Agarwal, A.; Belgrave, D.; Cho, K.; and Oh, A., eds., Proceedings of the Thirty-Sixth Annual Conference on Neural Information Processing Systems (NeurIPS '22) , volume 35 of Advances in Neural Information Processing Systems , 24824-24837. New Orleans, LA, USA: Curran Associates.

Wu, Q.; Bansal, G.; Zhang, J.; Wu, Y.; Li, B.; Zhu, E.; Jiang, L.; Zhang, X.; Zhang, S.; Liu, J.; Awadallah, A. H.; White, R. W.; Burger, D.; and Wang, C. 2024. AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation. In Proceedings of the First Conference on Language Modeling , COLM '24. Philadelphia, PA, USA: OpenReview.

Wu, T.; Jiang, E.; Donsbach, A.; Gray, J.; Molina, A.; Terry, M.; and Cai, C. J. 2022. PromptChainer: Chaining Large Language Model Prompts through Visual Programming. In Extended Abstracts of the 2022 CHI Conference on Human Factors in Computing Systems , CHI EA '22, 359:1-359:10. New Orleans, LA, USA: Association for Computing Machinery. ISBN 9781450391566.

Xi, Z.; Chen, W.; Guo, X.; He, W.; Ding, Y.; Hong, B.; Zhang, M.; Wang, J.; Jin, S.; Zhou, E.; Zheng, R.; Fan, X.; Wang, X.; Xiong, L.; Zhou, Y.; Wang, W.; Jiang, C.; Zou, Y.; Liu, X.; Yin, Z.; Dou, S.; Weng, R.; Qin, W.; Yongyan Zheng, Y.; Qiu, X.; Huang, X.; Zhang, Q.; and Gui, T. 2025. The Rise and Potential of Large Language Model Based Agents: A Survey. Science China Information Sciences , 68(2): 121101.

Xie, Q.; Wang, Z.; Feng, Y.; and Xia, R. 2024. Ask Again, Then Fail: Large Language Models' Vacillations in Judgment. In Ku, L.-W.; Martins, A.; and Srikumar, V., eds., Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers) , ACL '24, 10709-10745. Bangkok, Thailand: Association for Computational Linguistics.

Xu, Z.; Sanghi, U.; and Kankanhalli, M. 2025. Bullying the Machine: How Personas Increase LLM Vulnerability. arXiv:2505.12692.
...
Yao, S.; Zhao, J.; Yu, D.; Du, N.; Shafran, I.; Narasimhan, K.; and Cao, Y. 2023. ReAct: Synergizing Reasoning and Acting in Language Models. In Proceedings of the Eleventh International Conference on Learning Representations , ICLR '23. Kigali, Rwanda: OpenReview.

Zamfirescu-Pereira, J.; Wong, R. Y.; Hartmann, B.; and Yang, Q. 2023. Why Johnny Can't Prompt: How Non-AI Experts Try (and Fail) to Design LLM Prompts. In Proceedings of the 2023 CHI Conference on Human Factors in Computing Systems , CHI '23, 437:1-437:21. Hamburg, Germany: Association for Computing Machinery. ISBN 9781450394215.

Zhang, Z.; Bai, F.; Gao, J.; and Yang, Y. 2024. ValueDCG: Measuring Comprehensive Human Value Understanding Ability of Language Models. arXiv:2310.00378.

Zhao, Q.; Wang, J.; Zhang, Y.; Jin, Y.; Zhu, K.; Chen, H.; and Xie, X. 2024. CompeteAI: Understanding the Competition Dynamics of Large Language Model-Based Agents. In Proceedings of the Workshop on Agentic Markets , 2526:12526:16. Vienna, Austria: JMLR.org.

Zhou, E.; Zheng, R.; Xi, Z.; Gao, S.; Fan, X.; Fei, Z.; Ye, J.; Gui, T.; Zhang, Q.; and Huang, X. 2023. RealBehavior: A Framework for Faithfully Characterizing Foundation Models' Human-Like Behavior Mechanisms. In Bouamor, H.; Pino, J.; and Bali, K., eds., Findings of the Association for Computational Linguistics: EMNLP 2023 , 1026210274. Singapore: Association for Computational Linguistics.

Zhuge, M.; Liu, H.; Faccio, F.; Ashley, D. R.; Csord´ as, R.; Gopalakrishnan, A.; Hamdi, A.; Hammoud, H. A. A. K.; Herrmann, V.; Irie, K.; et al. 2025. Mindstorms in Natural Language-Based Societies of Mind. Computational Visual Media , 11(1): 29-81.